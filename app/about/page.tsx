      ...
      <section className='relative w-full min-h-[70vh] flex items-center justify-center px-6 sm:px-8 py-20'>
        ...
        <div className='relative z-10 max-w-4xl mx-auto text-center flex flex-col items-center gap-8'>
          ...
          <p className='text-base sm:text-lg font-light text-muted-foreground max-w-2xl leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000 delay-400'>
            W Domowym Pięknie nie tylko sprzedajemy przedmioty. Kurujemy
            kolekcje, które niosą ze sobą duszę, historię rąk, które je
            stworzyły, i obietnicę trwałości.
          </p>
          <div className='flex gap-4 mt-4 animate-in fade-in slide-in-from-bottom-10 duration-1000 delay-600'>
            <Button
              asChild
              className='rounded-none px-8 py-6 text-[10px] tracking-[0.2em] uppercase font-semibold'
            >
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center'>
          <div className='relative aspect-square w-full bg-muted/30 group'>
            ...
            <div className='absolute -bottom-6 -right-6 w-48 h-48 border border-primary/20 bg-background/80 backdrop-blur-md p-6 hidden sm:flex flex-col justify-end gap-2'>
              ...
              <p className='text-xs font-serif italic'>
                Pasja do detalu, która stała się sposobem na życie.
              </p>
            </div>
          </div>
          ...
          <div className='flex flex-col gap-8'>
            ...
            <div className='space-y-6 text-sm sm:text-base font-light text-muted-foreground leading-relaxed'>
              <p>
                Wszystko zaczęło się w małym warsztacie na przedmieściach, gdzie
                pierwszy założyciel Domowego Piękna odkrył magię surowej gliny i
                naturalnego lnu. Fascynacja tym, jak jeden, dobrze wykonany
                przedmiot może zmienić atmosferę całego pokoju, przerodziła się
                w misję.
              </p>
              <p>
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-20 mt-16'>
            <div className='flex flex-col items-center text-center gap-6 group'>
              ...
              <p className='text-sm font-light text-muted-foreground leading-relaxed'>
                Wspieramy godną pracę i uczciwe wynagrodzenie. Znamy twarze
                ludzi, którzy tworzą nasze meble i tekstylia.
              </p>
            </div>
            ...
            <div className='flex flex-col items-center text-center gap-6 group'>
              ...
              <p className='text-sm font-light text-muted-foreground leading-relaxed'>
                Len, lite drewno, mosiądz, kamionka. Wybieramy surowce, które
                żyją, oddychają i szlachetnie się starzeją.
              </p>
            </div>
            ...
            <div className='flex flex-col items-center text-center gap-6 group'>
              ...
              <p className='text-sm font-light text-muted-foreground leading-relaxed'>
                Przeciwstawiamy się kulturze jednorazowości. Nasze produkty
                projektujemy tak, by cieszyły przez dekady.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className='flex gap-6 items-start'>
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <p className='text-sm font-light text-muted-foreground'>
                    Szukamy twórców, dla których praca jest formą medytacji i
                    wyrazem najwyższego kunsztu.
                  </p>
                </div>
              </div>
              <div className='flex gap-6 items-start'>
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <p className='text-sm font-light text-muted-foreground'>
                    Testujemy trwałość, dotyk i zapach. Każdy materiał musi
                    spełniać nasze rygorystyczne normy.
                  </p>
                </div>
              </div>
              <div className='flex gap-6 items-start'>
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <p className='text-sm font-light text-muted-foreground'>
                    Zanim produkt trafi do Ciebie, przechodzi przez nasze ręce,
                    byśmy mieli pewność, że jest doskonały.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className='max-w-7xl mx-auto flex flex-col items-center gap-16'>
          <div className='flex flex-col items-center text-center gap-4'>
            ...
            <h2 className='font-serif text-3xl sm:text-4xl lg:text-5xl font-normal leading-tight'>
              Ludzie, którzy{" "}
              <em className='italic font-light'>kochają to, co robią</em>.
            </h2>
          </div>
      ...
      <section className='relative py-32 px-6 sm:px-8 text-center'>
        <div className='max-w-3xl mx-auto flex flex-col items-center gap-8'>
          ...
          <p className='text-base font-light text-muted-foreground leading-relaxed'>
            Przejrzyj naszą najnowszą kolekcję i znajdź przedmioty, które będą
            Ci towarzyszyć przez lata.
          </p>
          <div className='flex flex-col sm:flex-row gap-4 mt-4'>
            <Button
              asChild
              className='rounded-none px-10 py-7 text-[10px] tracking-[0.2em] uppercase font-semibold'
            >
