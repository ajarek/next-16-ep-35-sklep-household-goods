          ...
          <div className='lg:col-span-5 flex flex-col'>
            ...
            <div className='py-10 flex flex-col gap-8'>
              <div className='flex flex-col gap-4'>
                ...
                <div className='flex gap-3'>
                  <button
                    className='w-8 h-8 rounded-full border-2 border-primary bg-primary/20 transition-transform hover:scale-110'
                    aria-label='Naturalny'
                  />
                  <button
                    className='w-8 h-8 rounded-full border border-border bg-foreground/10 transition-transform hover:scale-110'
                    aria-label='Ciemny'
                  />
                </div>
              </div>
              ...
              <div className='flex flex-col sm:flex-row gap-4'>
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isWishlisted
                      ? "text-red-500 bg-red-50/10 border-red-200"
                      : "text-foreground",
                  )}
                  aria-label='Ulubione'
                >
            ...
            <div className='flex flex-col mt-4'>
              <AccordionItem
                ...
                onClick={() =>
                  setActiveAccordion(
                    activeAccordion === "szczegoly" ? null : "szczegoly",
                  )
                }
              >
                Ten produkt został wykonany z najwyższej jakości surowców, z
                dbałością o najmniejszy detal. {product.details} użyty w tym
                projekcie pochodzi ze sprawdzonych, ekologicznych źródeł. Każdy
                egzemplarz jest unikatowy ze względu na naturalne różnice w
              ...
              <AccordionItem
                ...
                onClick={() =>
                  setActiveAccordion(
                    activeAccordion === "dostawa" ? null : "dostawa",
                  )
                }
              >
                Oferujemy darmową dostawę dla zamówień powyżej 500 PLN.
                Standardowy czas wysyłki to 2-4 dni robocze. Jeśli produkt nie
                spełni Twoich oczekiwań, masz 30 dni na darmowy zwrot bez
                podania przyczyny.
              </AccordionItem>
              ...
              <AccordionItem
                ...
                onClick={() =>
                  setActiveAccordion(
                    activeAccordion === "pielegnacja" ? null : "pielegnacja",
                  )
                }
              >
                Zalecamy czyszczenie miękką, lekko wilgotną szmatką. Unikać
                bezpośredniego kontaktu z silnymi detergentami oraz długotrwałej
                ekspozycji na mocne światło słoneczne, co pozwoli zachować
                głębię koloru i strukturę materiału na lata.
              </AccordionItem>
            </div>
            ...
            <div className='mt-12 p-8 bg-primary/5 border-l-2 border-primary/40 flex flex-col gap-3 italic'>
              <p className='text-sm font-serif text-foreground/80 leading-relaxed'>
                ...
                i codzienną harmonię. Ten element został stworzony, by wnosić
                spokój do Twojej przestrzeni.&rdquo;
              </p>
        ...
        <div className='max-w-4xl mx-auto flex flex-col items-center text-center gap-8'>
          <div className='flex flex-col gap-3'>
            ...
            <p className='text-sm font-light text-muted-foreground max-w-lg mx-auto'>
              ...
              kolekcjach rzemieślniczych i inspiracje do aranżacji wnętrz.
            </p>
          </div>
